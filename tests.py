...
urls_to_test = [
    ...
    # http://www.dagsavisen.no/nyemeninger/fra-kriminalisering-via-sykeliggj%C3%B8ring-til-normalisering-1.683548   <-- uses other date parsing logic (span.data-livestamp)
    # http://www.dagbladet.no/2016/01/27/kultur/podcast/alt_du_sier_er_feil_espen/kristopher_schau/espen_thoresen/42909264/     <-- use other date parsing code path
]
